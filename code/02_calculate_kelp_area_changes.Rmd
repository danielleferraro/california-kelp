...
Read in kelp coverage shapefiles from 1989, 1999, and 2002-2012. There appear to be two files associated with 2010. 
```{r eval = FALSE}
...
Make simple maps of each shapefile. Here I'll use  the `rnaturalearth` package to directly download a boundary of California from [Natural Earth](https://www.naturalearthdata.com/). 
```{r}
...
According to the DFW [website](https://wildlife.ca.gov/Conservation/Marine/Kelp/Aerial-Kelp-Surveys), not all regions of California were covered in each annual survey. It appears the two most recent surveys included (2015 and 2015) did cover all regions:
